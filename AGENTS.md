...
This project is indexed by GitNexus as **train-model** (268 symbols, 312 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
